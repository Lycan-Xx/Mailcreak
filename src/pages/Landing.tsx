            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Create, manage, and send beautiful newsletters with ease. Reach your audience effectively with Mailcreak's powerful email marketing platform.
                </p>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Powerful Email Editor</p>
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Create beautiful newsletters with our intuitive drag-and-drop editor.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Enterprise-grade security to protect your data and subscribers.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Automation Tools</p>
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Schedule and automate your email campaigns effortlessly.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Subscriber Management</p>
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Easily manage your subscribers and segment your audience.
                </p>
              </div>
            </div>
          </div>
